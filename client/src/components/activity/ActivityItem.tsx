    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap', marginBottom: '3px' }}>
          <span style={{ fontSize: '8px', color: 'var(--text-muted)', letterSpacing: '0.06em', opacity: 0.7, flexShrink: 0 }}>
          ...
          <span style={{ fontSize: '8px', color: 'var(--text-muted)' }}>#{event.taskId}</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
          {event.oldStatus === null ? (
            <span style={{
              fontSize: '8px', letterSpacing: '0.1em', color: 'var(--text-muted)',
              border: '1px solid var(--border)', padding: '1px 5px', borderRadius: '2px',
            }}>CREATED</span>
          ) : (
            <><StatusBadge status={event.oldStatus} /><span style={{ fontSize: '8px', color: 'var(--text-muted)' }}>→</span></>
          )}
          ...
          {event.owner && ownerColor && avatarStyle && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginLeft: '4px' }}>
              <div style={{
                ...
                fontSize: '7px', fontWeight: 700, fontFamily: 'var(--font-mono)',
                ...avatarStyle,
              }}>{agentInitials(event.owner)}</div>
              <span style={{ fontSize: '8px', color: ownerColor, letterSpacing: '0.06em', fontFamily: 'var(--font-mono)' }}>
                {event.owner}
              </span>
            </div>
          )}
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {isLong && (
          <span style={{ fontSize: '8px', color: 'var(--text-muted)', letterSpacing: '0.08em', cursor: 'pointer', textTransform: 'uppercase' }}>

          ...
          {['ALL', ...agentNames].map(agent => {
            ...
            return (
              <button
                ...
                onMouseLeave={e => { if (!isActive) e.currentTarget.style.color = isActive ? (agent === 'ALL' ? 'var(--active-text)' : color) : 'var(--text-muted)'; }}
              >
                {agent !== 'ALL' && (
                  <span style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            {!loading && (
              <div style={{ display: 'flex', gap: '8px', fontSize: '8px', color: 'var(--text-muted)', letterSpacing: '0.08em' }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                flexShrink: 0, animation: 'status-pulse 2s ease-in-out infinite',
              }}
            >
